Als je geen noten zoals `c4` in je code wil gebruiken dan kan je in plaats daarvan frequentiewaarden gebruiken. Je kunt waarden gebruiken tussen `150` en `10000`.
